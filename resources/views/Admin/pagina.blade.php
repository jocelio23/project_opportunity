                        ...
                        <tbody>
                            ...
                            <td>
                                <form action="{{route('vaga.destroy', $vag->id)}}" method="POST">
                                    ...
                                    @method('DELETE')
                                    <div class="col-12">
                                        <button class="btn btn-primary w-100 py-3" type="submit">Apagar oportunidade</button>
                                    </div>
                                </form>
                            </td>
            ...
            <div class="row justify-content-end">
                <div class="col-lg-8 col-md-6">
                    <div class="d-flex align-items-center justify-content-center" style="height: 75px;">
                        <p class="mb-0">&copy; <a class="text-white border-bottom" href="#">Jota Tech</a>. Todos os direitos reservados. 
                    </div>
                </div>
            </div>
        </div>
