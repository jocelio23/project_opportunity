    ...
    <div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container py-5">
            <div class="section-title text-center position-relative pb-3 mb-5 mx-auto" style="max-width: 600px;">
                <h5 class="fw-bold text-primary text-uppercase">Área de atualização</h5>
                ...
                <form action="{{ route('vaga.change', $vag->id) }}" method="POST">
                    ...
                    <div class="col-12">
                        Nome: *
                        <input type="nome" id="nome" name="nome" class="form-control border-1 bg-light px-4"
                            style="height: 55px;" required value="{{ $vag->nome }}">
                    </div>

                    <div class="col-12">
                        Descrição: *
                        <textarea name="descricao" class="form-control border-1 bg-light px-4 py-4" rows="4" required>  {{ $vag->descricao }}</textarea>
                    </div>
                    ...
                    <div class="col-12">
                        ...
                        <input type="text" name="salario" class="form-control border-1 bg-light px-4"
                            ...
                            style="height: 55px;" onkeypress="return numerais()" ; required value="{{ $vag->salario }}">
                    </div>
                    ...
                    <div class="col-12">
                        ...
                        <select name="tipo" class="form-control border-1 bg-light px-4"
                            ...
                            <p style="opacity: calc(0.5)">
                                <option value="{{ $vag->tipo }}">{{ $vag->tipo }}</option>
                            </p>
                    ...
                    <button class="btn btn-secondary w-100 py-3" type="submit" name="submit">Salvar mudanças</button>
                </form>
            </div>
        </div>
    </div>
